...
class ImageSlider extends Component<PropsType, StateType> {
  ...
  _renderImage = (image: any, index: number) => {
    ...
    const imageObject = typeof image === 'string' ? { uri: image, headers:{ Authorization: 'someAuthToken' } } : image;

    const imageComponent = (
      <Image key={index} resizeMode={resizeMode} source={imageObject} style={[imageStyle]} />
    );
